...
//                plistData.hororscope = Array(plistData.dailyHororscope.keys)
                ...
                hororscope = Array(allData.values)  // the valeus is an array of array of strings
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "showDetail"
        {
           ...
           // let index = allData.index(forKey: temp)
            ...
            detailVC.dailyLabel = hororscope[horindex] 
            print("the hororscope vaue", hororscope[horindex])
