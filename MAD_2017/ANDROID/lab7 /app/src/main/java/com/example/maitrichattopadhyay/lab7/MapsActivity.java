package com.example.maitrichattopadhyay.lab7;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,  GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        buildGoogleApiClient(); // calling initializer method

        checkLocationPermission();// another user defined function to check for permissions
    }

    // this initializes google maps. we created this
    ...
    // CheckLocationPermission directly calls this
    @Override
    ...
    // gets called whenever location is updated
    @Override
    public void onLocationChanged(Location location) {
        // method is called automaticslly when user location changes
        //set current location to the new location
        mCurrentLocation = location; // new location
        ...
        if (mCurrentLocationMarker == null) {
            ...
            //set position of existing marker // if there was a marker, move it to the new position
            mCurrentLocationMarker.setPosition(latLng);
        }

        //move map camera
        mMap.moveCamera(CameraUpdateFactory.newLatLng(latLng)); // we are moving the map to the place of the marker
