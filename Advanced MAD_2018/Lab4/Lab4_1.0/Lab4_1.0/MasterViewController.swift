...
class MasterViewController: UITableViewController {
    ...
    var petitions = [petetion]()  // the struct I just made
    ...
    func loadjson(){
        ...
        //must call resume to run session. this is what starts the Session. Without this the session will not start
        session.resume()
    }
    ...
    func parsejson(_ data: Data){
        ...
        do {
            ...
            //get all results
            let allresults = json["results"] as! [[String:Any]]  // results was the name of the whole array in the data we are using
            print(allresults)
            ...
            for result in allresults
            {
                ...
                //create new object
                let newpetition = petetion(title: newtitle, sigCount: newsigCount, url: newurl) // passing petetion new values
                //add object to array
